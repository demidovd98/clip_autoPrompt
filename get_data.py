...
def get_dataset_imagenet(transform=None, from_source=False, templates="clip_all", num_classes='full'):
    ...
    if num_classes == 'full':
        num_classes_temp=1000
        classes = get_classes_imagenet()
    elif num_classes == '100':
        classes = get_classes_imagenet100()
...
def get_dataset_imagenet_v2(transform=None, from_source=False, templates="clip_all", num_classes='full'):
...
def get_dataset_cifar10(transform=None, templates="clip_all"):
    ...
    # trainset = torchvision.datasets.CIFAR10(root=location, train=True,
...
def get_classes_imagenet100():
    ...
    imagenet_classes_temp = get_classes_imagenet()
