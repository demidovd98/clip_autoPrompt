...
from utils_data.prompts_preparation import prepare_prompts
from utils_data.prompts_search_by_word_parall import search_prompts

from data.get_dataset import get_classes_imagenet, get_classes_cifar10, get_classes_cifar100
#from get_dataset import get_classes_imagenet, get_classes_cifar10, get_classes_cifar100
...
DIVISION = ['5words', '3words', '2words', '1words'] #['Sent', '7words', '6words', '5words', '4words', '3words', '2words', '1words']
...
if DATASET == 'cifar10':
    ...
    if DIFFICULTY == 'easy':
        ...
        raise Exception(f"[ERROR] ImageNet with specified number of classes {DIFFICULTY} is not in the list") 
else:
    PLURALS = ['s', 'es', 'ies']
...
folder = "/l/users/20020067/Activities/CLIP_prompts/clip_autoPrompt/data/prompts_our/" \
                + str(DATASET) + "_cls" + str(len(classes)) + "_p" + str(NUM_OF_SENTENCES) + "_" + str(epoch_time)
...
if prepare_only:
    ...
    search_prompts(dataset=DATASET, folder=folder, classes=classes, difficulty=DIFFICULTY, numb_of_sent=NUM_OF_SENTENCES, 
                        plurals=PLURALS, strict=STRICT, strict_symb=STRICT_SYMB, options=OPTIONS)
