...
'''
# path_x = '/home/demidova/docs/projects/tax/tax_t5/SemEval2018-Task9/training/data/1A.english.training.data.txt'
# path_y = '/home/demidova/docs/projects/tax/tax_t5/SemEval2018-Task9/training/gold/1A.english.training.gold.txt'

path_x_test = '/home/demidova/docs/projects/tax/tax_t5/SemEval2018-Task9/test/data/1A.english.test.data.txt'
# path_y_test = '/home/demidova/docs/projects/tax/tax_t5/SemEval2018-Task9/test/gold/1A.english.test.gold.txt'
...
with open("/l/users/20020067/Datasets/UMBC_corpus/" + str(DATASET) + "_sentences_" + str(DIFFICULTY) + "_sent" + str(NUM_OF_SENTENCES) + "_rand" + str(epoch_time) + ".tsv", "w") as output:
    skipped_lines = 0
    check = 0
