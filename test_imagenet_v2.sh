...
python3 -W ignore main.py --dataset imagenet_v2_100 --test_mode my_cls_only --templates_type our --prompts_per_cls 100 --prompt_words_num 1 --silent
...
python3 -W ignore main.py --dataset imagenet_v2_100 --test_mode my_cls_among_all --templates_type our --prompts_per_cls 100 --prompt_words_num 1 --silent
python3 -W ignore main.py --dataset imagenet_v2_100 --test_mode my_cls_among_all --templates_type our --prompts_per_cls 100 --prompt_words_num 2 --silent
